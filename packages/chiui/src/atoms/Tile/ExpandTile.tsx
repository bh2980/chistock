...
const ExpandTile: PolymorphicComponentType<"article", ExpandTilePropsType> =
  forwardRef(function ExpandTile<T extends React.ElementType>(
    {
      collapseHeight,
      ...
      return (
        ...
        >
          <div className="flex flex-col w-full relative gap-s">
            <div className="h-[calc(100%-32rem)] overflow-hidden">
              {children}
            </div>
            <Button
              variant={"text"}
