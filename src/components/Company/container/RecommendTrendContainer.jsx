...
import RecommendTrend from '../components/RecommendTrend';

const RecommendTrendContainer = ({ dashBoardInfo }) => {
	...
	return isLoad ? null : (
		<RecommendTrend recommendSeries={recommendSeries} recommendOptions={recommendOptions} />
	);
};

export default RecommendTrendContainer;
