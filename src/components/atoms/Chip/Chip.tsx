...
export const ChipGroup = ({ defaultSelected, ...props }: chipGroupProps) => {
  ...
  return (
    <ChipContext.Provider value={{ selectedChipList, dispatchSelectedChipList }}>
